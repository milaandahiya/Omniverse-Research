...
You may also use the Nvidia Nucleus connector in Omniverse to import/export USDs to a local or remote Omniverse server: https://docs.omniverse.nvidia.com/con_connect/con_connect/blender/nucleus-connector.html#blender-nucleus-connector. I have not tested this yet as I am working everything locally.

## Notes

The .vscode isn't necessary but prevents the `import omni` statements from being shown as an error in VSCode.
